...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD~ZmshGYYC#gAgxRfZLrAgUKL9Dy5pmsc6qZYfBh2SVSH68LvC6HfU",
BOT_NUMBER: process.env.BOT_NUMBER || "+94765501638",
PASSWORD: process.env.PASSWORD || "Enter you like password",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "sanchitha23973",
GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN || "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"
};
